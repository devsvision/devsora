function devsoraLanding() {
  const translations = {
    en: {
      ...
      tools: [
        { image: 'assets/images/generated/tool-merge.png', title: 'Merge Photos', text: 'Combine multiple images into one polished AI composition for campaigns, catalogs, and creative mockups.' },
        { image: 'assets/images/generated/tool-product.png', title: 'Product Photoshoot', text: 'Turn product photos into professional studio, lifestyle, and campaign-ready scenarios.' },
        { image: 'assets/images/generated/tool-model.png', title: 'AI Model Photo', text: 'Create professional AI model visuals for fashion, beauty, personal brand, and social campaigns.' },
      ],
      gallery: [
        { title: 'Merged campaign concept', caption: 'Merge Photos', size: 'wide', image: 'assets/images/generated/gallery-merge.png' },
        { title: 'Product studio set', caption: 'Product Photoshoot', size: 'tall', image: 'assets/images/generated/gallery-product.png' },
        { title: 'Editorial model set', caption: 'AI Model Photo', size: '', image: 'assets/images/generated/gallery-model.png' },
      ],
      compare: {
        before: 'Before',
        after: 'After',
        beforeImage: 'assets/images/generated/compare-before.png',
        afterImage: 'assets/images/generated/compare-after.png',
    ...
    id: {
      ...
      tools: [
        { image: 'assets/images/generated/tool-merge.png', title: 'Gabung Foto', text: 'Gabungkan beberapa gambar menjadi satu komposisi AI yang rapi untuk kampanye, katalog, dan mockup kreatif.' },
        { image: 'assets/images/generated/tool-product.png', title: 'Photoshoot Produk', text: 'Ubah foto produk menjadi skenario studio, lifestyle, dan kampanye profesional.' },
        { image: 'assets/images/generated/tool-model.png', title: 'Foto Model AI', text: 'Buat visual model AI profesional untuk fashion, beauty, personal brand, dan kampanye sosial.' },
      ],
      gallery: [
        { title: 'Konsep kampanye gabungan', caption: 'Gabung Foto', size: 'wide', image: 'assets/images/generated/gallery-merge.png' },
        { title: 'Set studio produk', caption: 'Photoshoot Produk', size: 'tall', image: 'assets/images/generated/gallery-product.png' },
        { title: 'Set model editorial', caption: 'Foto Model AI', size: '', image: 'assets/images/generated/gallery-model.png' },
      ],
      compare: {
        before: 'Sebelum',
        after: 'Sesudah',
